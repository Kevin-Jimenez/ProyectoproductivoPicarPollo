    ...
    <div class="ms-content-wrapper">
      <div class="row">
        ...
        ?>
              ...
              <form action="buscar_emp.php" method="get" class="form_search">
              ...
              include "../../../Confing/conexion.php";
               ...
               $rol = '';
                 ...
                 WHERE (u.rol = 2) AND (e.documento_e LIKE '%$busqueda%' OR u.nombre_u LIKE '%$busqueda%'
                  OR e.apellido_e LIKE '%$busqueda%')");
                 ...
                 $total_paginas = ceil($total_registro / $por_pagina);
                    $query = mysqli_query($conection,"SELECT e.id_empleado, u.nombre_u, e.documento_e, e.apellido_e, e.telefono_e, u.usuario, u.rol,u.id_usuario
                                                            FROM empleado e INNER JOIN usuario u ON e.id_usuario = u.id_usuario
                                                            WHERE u.rol = 2 AND (documento_e LIKE '%$busqueda%' 
                                                                OR nombre_u LIKE '%$busqueda%'
                                                                OR apellido_e LIKE '%$busqueda%') 
                    ...
                    ?>
                        ...
                        <td><?php echo $data["documento_e"]?></td>
                            ...
                            <td>
                              ...
                              <a style=" margin-top: -4px;width: 25px;height: 25px;padding: 1px;" href="eliminar_confirmar_emp.php?id=<?php echo $data["id_usuario"]?>" class="btn btn-primary d-block">

...
<head>
  ...
  <title>Lista Meseros | Administradores | Picar Pollo </title>
  <!-- Iconic Fonts -->
          ...
          <div class="ms-panel">
            ...
            <div class="ms-panel-body">
              ...
              <form action="buscar_emp.php" method="get" class="form_search">
                  ...
                  <input  style=" margin-top: -4px;width: 5px;height: 25px;padding: 1px;" type="submit" value="Buscar" class="btn btn-primary ">
              </form><br>
              ...
              include "../../../Confing/conexion.php";
               ...
               $sql_registe = mysqli_query($conection,"SELECT COUNT(*) AS total_registro, u.rol
                                                                            FROM empleado e INNER JOIN usuario u ON e.id_usuario = u.id_usuario WHERE u.rol = 2 ");
               ...
               //  CALL `Select_usuario`(@p0, @p1, @p2, @p3, @p4);
                  ...
                  $query = mysqli_query($conection,"SELECT * FROM select_emp
                  ...
                  ?>
                      <tr>
                          ...
                          <td >
                              ...
                              <a style=" margin-top: -4px;width: 25px;height: 25px;padding: 1px;" href="eliminar_confirmar_empleado.php?id=<?php echo $data["id_usuario"]?>" class="btn btn-primary">

...
<head>
  ...
  <title>Eliminar Producto| Picar Pollo </title>
  <!-- Iconic Fonts -->
...
<body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
  ...
  <main class="body-content">
    ...
    if (empty($_REQUEST['id']) ||$_REQUEST['id'] == 1 ) {
        ...
        $query = mysqli_query($conection,"SELECT id_producto, nombre_p, descripcion_P, imagen_p
                                                    FROM producto  
                                                    WHERE (id_producto = $idusuario AND estatus = 1)");
        mysqli_close($conection);
        ...
        if ($result > 0) {
            while ($data = mysqli_fetch_array($query)) {
                ...
                $descripcion = $data['descripcion_P'];
                $foto = '<img id="img" src="../Registrar/img/uploads/'.$data['imagen_p'].'" alt="producto">';
            }
        }else{
...
<section id="container">
        <div class="form_register">
            ...
            <div class="form-row">
                ...
                <div class="col-md-6 mb-3">
                <p><h6><strong style="font-size:20px;">Descripcion:&nbsp;</strong> <i><span style="font-size:20px;letter-spacing: 2px;"><?php echo $descripcion; ?></h6></span></i></p>
                </div> 
            </div>

                <form action="../../../Models/Delete/eliminar_pro.php"  method="post">

...
<head>
  ...
  <title>Lista Mesas | Administradores | Picar Pollo </title>
  <!-- Iconic Fonts -->
        ...
        ?>
            ...
            <div class="ms-panel-body">
              ...
              include "../../../Confing/conexion.php";
               //paginador
               $sql_registe = mysqli_query($conection,"SELECT COUNT(*) AS total_registro FROM mesa WHERE numero_m LIKE '%$busqueda%'");
                 ...
                 $total_paginas = ceil($total_registro / $por_pagina);
                    $query = mysqli_query($conection,"SELECT * FROM mesa WHERE numero_m LIKE '%$busqueda%'
                                                            ORDER BY numero_m ASC
                    ...
                    ?>
                        <tr>
                            <td><?php echo $data["numero_m"]?></td>
                            <td><?php echo $data["espacios_m"]?></td>
                            <td ><?php 
                                    if ($data["estado"] == 1) {
                                        echo '<p style="color: rgb(52, 179, 52);font-size:15px" ><i><b>Disponible</i></b></p>';
                                    }elseif ($data["estado"] == 2) {
                                        echo '<p style="color: rgb(179, 52, 52);font-size:15px"><i><b>Ocupado</i></b></p>';
                                    }else {
                                        echo '<p style="color: rgb(179, 160, 52);font-size:15px"><i><b>Fuera de servicio</i></b></p>';
                                    }
                                ?></td>
                            
                            <td>
                                <a style=" margin-top: -4px;width: 25px;height: 25px;padding: 1px;" href="../Edit/E_mesa.php?id=<?php echo $data["id_mesa"]?>" class="btn btn-warning d-block">

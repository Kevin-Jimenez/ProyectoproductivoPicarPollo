...
<head>
  ...
  <title>Lista Usuarios | Administradores | Picar Pollo </title>
  <!-- Iconic Fonts -->
            ...
            <div class="ms-panel-body">
              ...
              include "../../../Confing/conexion.php";
               ...
               //  CALL `Select_usuario`(@p0, @p1, @p2, @p3, @p4);
                  ...
                  $query = mysqli_query($conection,"SELECT * FROM select_us
                  ...
                  ?>
                      <tr>
                            ...
                            <td >
                              ...
                              <a style=" margin-top: -4px;width: 25px;height: 25px;padding: 1px;" href="../Administradores/eliminar_confirmar_u.php?id=<?php echo $data["id_usuario"]?>" class="btn btn-primary d-block">

...
<head>
  ...
  <title>Perfil | Administrador | Picar Pollo </title>
  <!-- Iconic Fonts -->
    ...
    <div class="ms-content-wrapper">
      ...
      <div class="ms-profile-overview">
        <div class="ms-profile-cover">
          <img class="ms-profile-img" src="../../../librerias/assets/img/costic/customer-6.jpg" alt="people">
          <div class="ms-profile-user-info">
            <h4 class="ms-profile-username text-white"><?php echo $_SESSION['nombre'];?></h4>
            <h2 class="ms-profile-role">Administrador</h2>
          </div>
        </div>

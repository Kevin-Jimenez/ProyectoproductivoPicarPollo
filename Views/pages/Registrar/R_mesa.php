...
<head>
  ...
  <title>Registar Mesa | Picar Pollo </title>
  <!-- Iconic Fonts -->
          ...
          <div class="ms-panel ms-panel-fh">
            ...
            if (!empty($_POST)) {
                ...
                if (empty($_POST['numero']) || empty($_POST['espacio']) || empty($_POST['estado'])) {
                    ...
                    $numero = $_POST['numero'];
                    $espacios = $_POST['espacio'];
                    $estado = $_POST['estado'];
        
        
        
                    $query = mysqli_query($conection,"SELECT id_mesa FROM mesa WHERE numero_m = '$numero'");
                    $result = mysqli_fetch_array($query);
                    
                       if ($result > 0) {
                            $alert='<p class="msg_error"> La mesa ya se encuentra registrada con ese numero.</p>';
                        }else {
        
                            $query_insert = mysqli_query($conection,"INSERT INTO mesa(numero_m,espacios_m,estado) 
                                                                                VALUES('$numero','$espacios',$estado)");
                            
        
                            if ($query_insert) {
                                $alert='<p style="color: rgba(50, 202, 50, 0.87);font-size: 15px; "><b><i>Mesa ingresado correctamente</b></i></p>';
                            }else {
                                $alert='<p style="color: rgba(202, 55, 50, 0.87);font-size: 15px; "><b><i> ERROR al ingresar  Mesa.</b></i> </p>';
                            }
                    }
                }
            ...
            <section id="container">
                <div class="form_register">
                    <div class="page-header">
                        <strong style="font-size:40px;">Registrar Mesa</strong>
                    </div>
                    <div class="Aregistro">
                    ...
                    <form class="needs-validation clearfix" novalidate action="" method="post" autocomplete="off">
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                  <input type="number" pattern="[0-9]+" title="Digite solo Numeros" class="form-control" name="numero" id="numero" placeholder="Numero de mesa *" required="">
                            ...
                            <div class="input-group">
                                <input type="number" pattern="[0-9]+" title="Digite solo Numeros" class="form-control" name="espacio" id="espacio" placeholder="espacio de mesa *" required="">
                            <div class="invalid-feedback">Complete el campo con numeros enteros..</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    <select name="estado" class="form-control" id="rol">
                        ...
                        <div class="form-row">
                            <input type="submit" class="btn btn-primary d-block" value="Crear Mesa">
                        </div>
                    </form>
        </div>
                </div>
